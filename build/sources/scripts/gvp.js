 ...
 * https://modernizr.com/download/?-json-video-setclasses !*/
!function (e, n, a) {
  function o(e, n) {
    return (typeof e === "undefined" ? "undefined" : _typeof(e)) === n;
  }function s() {
    var e, n, a, s, t, i, r;for (var p in l) {
      if (l.hasOwnProperty(p)) {
        if (e = [], n = l[p], n.name && (e.push(n.name.toLowerCase()), n.options && n.options.aliases && n.options.aliases.length)) for (a = 0; a < n.options.aliases.length; a++) {
          e.push(n.options.aliases[a].toLowerCase());
        }for (s = o(n.fn, "function") ? n.fn() : n.fn, t = 0; t < e.length; t++) {
          i = e[t], r = i.split("."), 1 === r.length ? Modernizr[r[0]] = s : (!Modernizr[r[0]] || Modernizr[r[0]] instanceof Boolean || (Modernizr[r[0]] = new Boolean(Modernizr[r[0]])), Modernizr[r[0]][r[1]] = s), c.push((s ? "" : "no-") + r.join("-"));
        }
      }
    }
  }function t(e) {
    ...
    return "function" != typeof n.createElement ? n.createElement(arguments[0]) : f ? n.createElementNS.call(n, "http://www.w3.org/2000/svg", arguments[0]) : n.createElement.apply(n, arguments);
      ...
      l = [],
      r = { _version: "3.5.0", _config: { classPrefix: "", enableClasses: !0, enableJSClass: !0, usePrefixes: !0 }, _q: [], on: function on(e, n) {
      ...
      Modernizr = function Modernizr() {};Modernizr.prototype = r, Modernizr = new Modernizr(), Modernizr.addTest("json", "JSON" in e && "parse" in JSON && "stringify" in JSON);var p = n.documentElement,
  ...
  }), s(), t(c), delete r.addTest, delete r.addAsyncTest;for (var d = 0; d < Modernizr._q.length; d++) {
    Modernizr._q[d]();
...
var fileExist = function () {
    ...
    return function fileExist(_x3) {
        return _ref.apply(this, arguments);
    };
}();

var remoteYTCaptionExist = function () {
    ...
    return function remoteYTCaptionExist(_x4) {
...
var getFile = function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(file) {
        ...
        var httpHeaders, options, response, data;
...
function initGVP() {
    ...
    var manifestURL = document.getElementById('gvp-manifest').href;
    ...
    getFile(manifestURL, true).then(function (result) {
...
function setGvpTemplate() {
    ...
    getFile(gvp.template).then(function (result) {

        if (result) {

            var gvpWrapper = document.getElementById('gvp-wrapper');
            ...
            if (!flags.isIframe) {
                ...
                var copyrightYearHolder = document.getElementsByClassName('gvp-copyright-year')[0];
                var date = new Date();
                ...
                var noticeHolder = document.getElementById('gvp_notice');
...
function setGvpUi() {
    ...
    // display logo
    var logoURL = manifest.gvp_logo_directory + program.name + '.svg';

    fileExist(logoURL).then(function (result) {

        var programLogoDiv = document.getElementsByClassName('gvp-program-logo');
        var url = logoURL;
        ...
        for (var i = 0; i < programLogoDiv.length; i++) {
...
function setProgramTheme() {
    ...
    var decorationBar = document.getElementsByClassName('gvp-decoration-bar')[0];
...
function getVideoSource() {
    ...
    getFile(xml.file).then(function (result) {
        ...
        if (result) {
            ...
            if (xml.doc != null) {
                ...
                if (xml.markersTag !== undefined) {
                    ...
                    if (xml.doc.getElementsByTagName('markers')[0].querySelectorAll('marker').length) {
                        ...
                        var markerTag = xml.doc.getElementsByTagName('marker');
            ...
            if (xml.doc.getElementsByTagName('kalturaId')[0] !== undefined) {
                ...
                if (xml.kalturaTag !== undefined) {
                    ...
                    if (xml.kalturaTag.childNodes[0] !== undefined && xml.kalturaTag.childNodes[0].nodeValue.trim() != '') {
            ...
            if (xml.doc.getElementsByTagName('youtubeId')[0] !== undefined) {
                ...
                if (xml.youtubeTag !== undefined) {
                    ...
                    if (xml.youtubeTag.childNodes[0] !== undefined && xml.youtubeTag.childNodes[0].nodeValue.trim() != '') {
            ...
            if (xml.fileNameTag !== undefined) {
                ...
                if (xml.fileNameTag.childNodes[0] !== undefined && xml.fileNameTag.childNodes[0].nodeValue.trim() != '') {
...
function loadVideoJS() {
    ...
    player = videojs('gvp-video', playerOptions, function () {
        ...
        if (flags.isKaltura && flags.isLocal === false) {
            ...
            self.updateSrc([{ type: 'video/mp4', src: kaltura.flavor.low, label: 'low', res: 360 }, { type: 'video/mp4', src: kaltura.flavor.normal, label: 'normal', res: 720 }, { type: 'video/mp4', src: kaltura.flavor.medium, label: 'medium', res: 640 }]);
        ...
        self.on('playing', function () {
            ...
            var logo = document.getElementsByClassName('gvp-program-logo')[1];
            logo.style.display = 'none';

            if (flags.isIframe) {
                var titleBar = document.getElementsByClassName('gvp-title-bar')[0];
        ...
        self.on('error', function () {
            ...
            var msg = 'Please double check the file name.<br>Expecting: ' + self.currentSrc() + '<br><br>';
        ...
        if (flags.isYouTube) {
            ...
            var ytCaption = 'https://www.youtube.com/api/timedtext?fmt=vtt&v=' + gvp.source + '&lang=en';

            var ytPromise = new Promise(function (resolve, reject) {

                resolve(remoteYTCaptionExist(ytCaption));
                reject(noYTCaptionExist());
            });

            ytPromise.then(function (result) {
...
function setTitle() {
    ...
    if (xml.doc !== null) {
        ...
        if (xml.titleTag !== undefined) {
            ...
            if (xml.titleTag.childNodes[0] !== undefined && xml.titleTag.childNodes[0].nodeValue.trim() !== '') {
...
function hideCover() {
    ...
    setTimeout(function () {
        ...
        var cover = document.getElementsByClassName('gvp-cover')[0];
...
function addForwardButton(vjs) {
    ...
    var forwardTenBtn = videojs.extend(Button, {
        ...
        handleClick: function handleClick() {
            ...
            if (vjs.seekable()) {
                ...
                var seekTime = vjs.currentTime() + secToSkip;
...
function addDownloadFilesButton(vjs) {
    ...
    setTimeout(function () {
        ...
        var downloadButton = videojs.extend(MenuButton, {
            constructor: function constructor(player, options) {
...
function downloadables(vjs) {
    ...
    var files = document.getElementsByClassName('gvp-downloads')[0].childNodes;
    var items = [];
    ...
    DownloadMenuItem.prototype.handleClick = function () {
        ...
        if (this.options_.kaltura === true) {
            ...
            if (this.options_.id === 'videoDl') {
                ...
                var videoUrl = document.getElementById(this.options_.id).href;
                var xhr = new XMLHttpRequest();
                ...
                xhr.onload = function () {
                    ...
                    if (this.status === 200) {
                        ...
                        var link = document.getElementById('videoDl');
    ...
    for (var i = 0; i < files.length; i++) {
        ...
        var fileLabel = files[i].childNodes[0].nodeValue;
        ...
        items.push(new DownloadMenuItem(vjs, {
            label: fileLabel,
            id: fileId,
            kaltura: isKaltura
        }));
...
function setDownloadables() {
    ...
    var supportedFiles = manifest.gvp_download_files;
    var fileName = gvp.source;
    ...
    supportedFiles.forEach(function (file) {
        ...
        var ext = file.format;
        var filePath = cleanString(fileName) + '.' + ext;

        // video
        if (ext === "mp4") {

            var dwnldPath = filePath;
        ...
        fileExist(filePath).then(function (result) {
...
function createDownloadLink(name, path, label) {
    ...
    var downloads = document.getElementsByClassName('gvp-downloads')[0];
...
function queryToSeconds(str) {
    ...
    var hrIndex = str.indexOf('h');
    var minIndex = str.indexOf('m');
    var secIndex = str.indexOf('s');
...
function showErrorMsgOnCover(str) {
    ...
    var msg = document.getElementsByClassName('gvp-error-msg')[0];
